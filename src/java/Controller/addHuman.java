 ...
 * @author admin
 */
public class addHuman extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet addHuman</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet addHuman at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
...
//        processRequest(request, response);
            ...
            request.setAttribute("listHumanType", listHumanType);
